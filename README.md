...
| **IA & SAFe : les LLM et l'agilite a l'echelle** | 9 chapitres (parcours Delivery & Agilite, niveau intermediaire), sources citees (DORA, METR, HBS/BCG, NBER, Faros, GitClear, Scaled Agile) : ce que changent les LLM, etat de la recherche, deplacement du goulot, AI-Native SAFe (2026), equipe AI-native, PO augmente, planification par outcomes, gouvernance & risques, organisation agile AI-native. Donnees dans `site/formation-ia-safe.js`. |
